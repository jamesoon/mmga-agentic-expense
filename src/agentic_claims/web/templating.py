...
from agentic_claims.core.config import getSettings as _getSettings  # noqa: E402

try:
    templates.env.globals["appVersion"] = _getSettings().app_version
except Exception:
    templates.env.globals["appVersion"] = "1.0.0"
