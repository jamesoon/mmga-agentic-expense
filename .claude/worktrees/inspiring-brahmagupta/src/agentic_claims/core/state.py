...
class ClaimState(TypedDict):
    ...
    complianceFindings: Optional[dict]  # {pass: bool, violations: [...], citedClauses: [...]}
    fraudFindings: Optional[dict]  # {riskScore: float, duplicates: [...], anomalies: [...]}

    # Phase 4: Advisor decision and reviewer — jamesoon
    advisorDecision: Optional[dict]  # {action: "approve"|"return"|"escalate", reasoning: str}
    reviewerComments: Optional[str]  # Reviewer notes when taking action
